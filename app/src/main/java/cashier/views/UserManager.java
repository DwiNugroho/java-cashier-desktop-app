...
public class UserManager extends javax.swing.JFrame {
	...
	private void attachOnSelectionEvent() {
		userTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
			public void valueChanged(ListSelectionEvent evt) {
				...
				currentUser.setUserID(Integer.parseInt(userTable.getValueAt(selectedRow, 0).toString()));
	...
	*/
	...
	private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
		User user = new User();
		int selectedRow = userTable.getSelectedRow();
		user.setUserID(Integer.parseInt(userTable.getValueAt(selectedRow, 0).toString()));
